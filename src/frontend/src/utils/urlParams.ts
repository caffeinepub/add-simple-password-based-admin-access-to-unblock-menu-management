...
/**
 * Sets a secret parameter directly in sessionStorage
 * Used for manual admin password input without requiring URL manipulation
 *
 * @param key - The key to store the secret under
 * @param value - The secret value to store
 */
export function setSecretParameter(key: string, value: string): void {
    storeSessionParameter(key, value);
}
