...
export class Backend implements backendInterface {
    ...
    async addCategory(arg0: string, arg1: bigint): Promise<CategoryId> {
        if (this.processError) {
            try {
    ...
    async addFoodItem(arg0: string, arg1: string, arg2: number, arg3: boolean, arg4: CategoryId, arg5: bigint): Promise<FoodItemId> {
        if (this.processError) {
            try {
                const result = await this.actor.addFoodItem(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFoodItemsForCategory(arg0: CategoryId): Promise<Array<FoodItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFoodItemsForCategory(arg0);
                return from_candid_vec_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reorderCategories(arg0: Array<CategoryId>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async reorderFoodItems(arg0: Array<FoodItemId>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reorderFoodItems(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleCategoryEnabled(arg0: CategoryId, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleCategoryEnabled(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleFoodItemEnabled(arg0: FoodItemId, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.toggleFoodItemEnabled(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateFoodItem(arg0: FoodItemId, arg1: string, arg2: string, arg3: number, arg4: boolean, arg5: CategoryId): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateFoodItemImage(arg0: FoodItemId, arg1: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFoodItemImage(arg0, await to_candid_opt_n23(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_FoodItem_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _FoodItem): Promise<FoodItem> {
...
async function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_FoodItem>): Promise<Array<FoodItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_FoodItem_n11(_uploadFile, _downloadFile, x)));
}
